...
def descricao_app1():
    ...
    st.write(
        ...
        "- Relatórios Personalizados: Gera relatórios detalhados e personalizáveis para análise e download.\n\n"
...
def descricao_app2():
    ...
    st.write(
        ...
        "- Relatórios Gráficos: Apresenta gráficos e visualizações para facilitar a interpretação dos dados coletados.\n\n"
